...
if(isset($_POST['save'])){
      ...
      $query="INSERT INTO  footer_socailmedia(twitter,facebook,instagram)
...
if(isset($_POST['editN'])){
      ...
      $facebook=$_POST['facebook'];
      $instagram =$_POST['instagram'];
      $editQuery="UPDATE footer_socailmedia SET twitter='$twitter', facebook='$facebook', instagram='$instagram' WHERE id='$id'";
      $editResult= mysqli_query($conn,$editQuery);
} 
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="add_item_footer.php" method="post">
                    ...
                    <div class="btns">
                                          <?php
                                                if($update==true): ?>
                                          <a href="view_item_footer.php"><input class="btn btn-primary mr-2" type="submit"
                                                      name="editN" value="Edit"> </a>
                                          <?php else: ?>
                                          <a href="add_item_footer.php"><input class="btn btn-primary mr-2" type="submit"
                                                      name="save" value="Save"> </a>
                                          <?php endif; ?>
                                          <button class="btn btn-light">Cancel</button>
                                          <a href="view_item_footer.php" class="btn btn-primary mr-2">View all</a>
                                    </div>
                    </form>
                        </div>
                    </div>
