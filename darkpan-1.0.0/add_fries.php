...
if(isset($_POST['save'])){
      ...
      $price=$_POST['price'];
      $query="INSERT INTO fries_menu(image , title , description , price)
...
if(isset($_GET['edit'])){
      $id=$_GET['edit'];
      $update=true;
      $editQuery="SELECT * FROM fries_menu WHERE id=$id";
...
if(isset($_POST['editN'])){
      ...
      $editQuery="UPDATE fries_menu SET image='$image' , title='$title, description='$description , price='$price' WHERE id='$id'";
      $editResult= mysqli_query($conn,$editQuery);
} 
?>
<!DOCTYPE html>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form class="forms-sample" action="add_fries.php" method="POST">
                                ...
                                <div class="btns">
                                      <?php
                                            if($update==true): ?>
                                      <a href="view_fries.php"><input class="btn btn-primary mr-2" type="submit"
                                                  name="editN" value="Edit"> </a>
                                      <?php else: ?>
                                      <a href="add_fries.php"><input class="btn btn-primary mr-2" type="submit"
                                                  name="save" value="Save"> </a>
                                      <?php endif; ?>
                                      <button class="btn btn-light">Cancel</button>
                                      <a href="view_fries.php" class="btn btn-primary mr-2">View all</a>
                                </div>
                            </form>
                        </div>
                    </div>
