...
if(isset($_POST['save'])){
      ...
      $image =$_POST['image'];
      $price = $_POST['price'];
      $query="INSERT INTO users(recipe_name,image,price)
            VALUES('$recipe_name','$image','$price')";
...
if(isset($_POST['editUser'])){
      ...
      $image =$_POST['image'];
      $price = $_POST['price'];
      $editQuery="UPDATE users SET recipe_name='$recipe_name',
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form class="forms-sample" action="add_new_order.php" method="POST">
                                ...
                                <input type="text" class="form-control" id="recipe_name" placeholder="recipe_name" 
                                name="recipe_name" value="<?php echo $recipe_name ?>" />
                                </div>
                                <div class="form-group">
                                ...
                                <?php
                                if($update==true): ?>
                                <a href="view_all_order.php"><input class="btn btn-primary mr-2" type="submit"
                                name="editUser" value="Edit"> </a>
                                <?php else: ?>
                                    <a href="add_new_order.php"><input class="btn btn-primary mr-2" type="submit"
                                    name="save" value="Save"> </a>
                                    <?php endif; ?>
                                    <button class="btn btn-light">Cancel</button>
                                    <a href="view_all_order.php" class="btn btn-primary mr-2">View all </a>
                                    </div>
                            </form>
                        </div>
                    </div>
