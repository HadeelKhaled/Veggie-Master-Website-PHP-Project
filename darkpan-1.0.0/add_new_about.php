...
if(isset($_POST['save'])){
      ...
      $query="INSERT INTO  about(image , title , description )
...
if(isset($_POST['editN'])){
      ...
      $editQuery="UPDATE about SET image='$image' , title='$title, description='$description 'WHERE id='$id'";
      $editResult= mysqli_query($conn,$editQuery);
} 
?>
<!DOCTYPE html>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form class="forms-sample" action="add_to_about.php" method="POST">
                                ...
                                <div class="btns">
                                      <?php
                                            if($update==true): ?>
                                      <a href="view_all_about.php"><input class="btn btn-primary mr-2" type="submit"
                                                  name="editN" value="Edit"> </a>
                                      <?php else: ?>
                                      <a href="add_to_about.php"><input class="btn btn-primary mr-2" type="submit"
                                                  name="save" value="Save"> </a>
                                      <?php endif; ?>
                                      <button class="btn btn-light">Cancel</button>
                                      <a href="view_all_about.php" class="btn btn-primary mr-2">View all</a>
                                </div>
                            </form>
                        </div>
                    </div>
