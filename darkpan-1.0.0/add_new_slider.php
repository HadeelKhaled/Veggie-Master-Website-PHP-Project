...
if(isset($_POST['save1'])){
      ...
      $query="INSERT INTO   slider_one( title , description )
...
if(isset($_GET['edit1'])){
      $id=$_GET['edit1'];
      $update=true;
      $editQuery="SELECT * FROM  slider_one WHERE id=$id";
...
if(isset($_POST['editOne'])){
      ...
      $editQuery="UPDATE slider_one SET title='$title, description='$description 'WHERE id='$id'";
      $editResult= mysqli_query($conn,$editQuery);
} 
?>
...
if(isset($_POST['save2'])){
      $title=$_POST['title'];
      $description=$_POST['description'];
      $query="INSERT INTO   slider_two( title , description )
            VALUES( '$title' , '$description' )";
      $result= mysqli_query($conn,$query);}
...
if(isset($_GET['edit2'])){
      $id=$_GET['edit2'];
      $update=true;
      $editQuery="SELECT * FROM  slider_two WHERE id=$id";
      $editResult=mysqli_query($conn,$editQuery);
          if(mysqli_num_rows($editResult) != 0){
            $row=$editResult->fetch_array();
            $title=$row['title'];
...
if(isset($_POST['editTwo'])){
      
      $id=$_POST['id'];
      $title=$_POST['title'];
      $description=$_POST['description'];

      $editQuery="UPDATE slider_two SET title='$title, description='$description 'WHERE id='$id'";
      $editResult= mysqli_query($conn,$editQuery);
} 
?>
...
if(isset($_POST['save3'])){
      $title=$_POST['title'];
      $description=$_POST['description'];
      $query="INSERT INTO   slider_three( title , description )
            VALUES( '$title' , '$description' )";
      $result= mysqli_query($conn,$query);}
...
if(isset($_GET['edit3'])){
      $id=$_GET['edit3'];
      $update=true;
      $editQuery="SELECT * FROM  slider_three WHERE id=$id";
      $editResult=mysqli_query($conn,$editQuery);
          if(mysqli_num_rows($editResult) != 0){
            $row=$editResult->fetch_array();
            $title=$row['title'];
...
if(isset($_POST['editThree'])){
      
      $id=$_POST['id'];
      $title=$_POST['title'];
      $description=$_POST['description'];

      $editQuery="UPDATE slider_three SET title='$title, description='$description 'WHERE id='$id'";
      $editResult= mysqli_query($conn,$editQuery);
} 
?>
...
<head>
    <meta charset="utf-8">
    <title>Clever Mind - Admin Template</title>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Slide One</h6>
                            <form class="forms-sample" action="add_new_slider.php" method="POST">
                                ...
                                <div class="btns">
                                      <?php
                                            if($update==true): ?>
                                      <a href="view_all_slider.php"><input class="btn btn-primary mr-2" type="submit"
                                                  name="editOne" value="Edit"> </a>
                                      <?php else: ?>
                                      <a href="add_new_slider.php"><input class="btn btn-primary mr-2" type="submit"
                                                  name="save1" value="Save1"> </a>
                                      <?php endif; ?>
                                      <button class="btn btn-light">Cancel</button>
                                      <a href="view_all_slider.php" class="btn btn-primary mr-2">View all</a>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <form class="forms-sample" action="add_new_slider.php" method="POST">
                                ...
                                <div class="btns">
                                      <?php
                                            if($update==true): ?>
                                      <a href="view_all_slider.php"><input class="btn btn-primary mr-2" type="submit"
                                                  name="editTwo" value="Edit"> </a>
                                      <?php else: ?>
                                      <a href="add_new_slider.php"><input class="btn btn-primary mr-2" type="submit"
                                                  name="save2" value="Save2"> </a>
                                      <?php endif; ?>
                                      <button class="btn btn-light">Cancel</button>
                                      <a href="view_all_slider.php" class="btn btn-primary mr-2">View all</a>
                                </div>
                            ...
                            <form class="forms-sample" action="add_new_slider.php" method="POST">
                                ...
                                <div class="btns">
                                      <?php
                                            if($update==true): ?>
                                      <a href="view_all_slider.php"><input class="btn btn-primary mr-2" type="submit"
                                                  name="editThree" value="Edit"> </a>
                                      <?php else: ?>
                                      <a href="add_new_slider.php"><input class="btn btn-primary mr-2" type="submit"
                                                  name="save3" value="Save3"> </a>
                                      <?php endif; ?>
                                      <button class="btn btn-light">Cancel</button>
                                      <a href="view_all_slider.php" class="btn btn-primary mr-2">View all</a>
                                </div>
