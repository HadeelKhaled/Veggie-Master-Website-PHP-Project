...
if(isset($_POST['save'])){
      ...
      $query="INSERT INTO  header(website_name)
            VALUES('$website_name')";
...
if(isset($_POST['editN'])){
      ...
      $id=$_POST['id'];
      $website_name=$_POST['website_name'];
      $editQuery="UPDATE header SET website_name='$website_name'WHERE id='$id'";
      $editResult= mysqli_query($conn,$editQuery);
} 
?>
<!DOCTYPE html>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="website_name" placeholder="User Name" 
                      name="website_name" value="<?php echo $website_name ?>" />
                    </div>
                    <div class="btns">
                                          <?php
                                                if($update==true): ?>
                                          <a href="header.php"><input class="btn btn-primary mr-2" type="submit"
                                          ...
                                          <a href="header.php" class="btn btn-primary mr-2">View all</a>
                                    </div>
                  </form>
                        </div>
                    </div>
