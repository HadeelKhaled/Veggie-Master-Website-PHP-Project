...
if(isset($_GET['delete1'])){ 
      $id=$_GET['delete1'];
      $delQuery="DELETE FROM slider_one WHERE id=$id";
      $delResult= mysqli_query($conn,$delQuery);
}

if(isset($_GET['delete2'])){ 
    $id=$_GET['delete2'];
    $delQuery="DELETE FROM slider_two WHERE id=$id";
    $delResult= mysqli_query($conn,$delQuery);
}

if(isset($_GET['delete3'])){ 
    $id=$_GET['delete3'];
    $delQuery="DELETE FROM slider_three WHERE id=$id";
    $delResult= mysqli_query($conn,$delQuery);
}
?>
<!DOCTYPE html>
                                    ...
                                    <?php
                                       ...
                                       if ($countRow > 0) {
                                          ...
                                          while ($row = mysqli_fetch_assoc($result)) {
                                             ...
                                             <td>
                                             <a href='add_new_slider.php?edit1={$row['id']}'>
                                             <button data-toggle='tooltip' title='Edit' class='btn btn-primary mr-2'>
                                             Edit
                                             </button>
                                             </a>
                                             <a href='view_all_slider.php?delete1={$row['id']}'>
                                    ...
                                    <?php
                                       ...
                                       if ($countRow > 0) {
                                          ...
                                          while ($row = mysqli_fetch_assoc($result)) {
                                             ...
                                             <td>{$row['description']}</td>
                                             <td>
                                             <a href='add_new_slider.php?edit2={$row['id']}'>
                                             <button data-toggle='tooltip' title='Edit' class='btn btn-primary mr-2'>
                                             Edit
                                             </button>
                                             </a>
                                             <a href='view_all_slider.php?delete2={$row['id']}'>
                                             <button data-toggle='tooltip' title='Trash' class='btn btn-primary mr-2'>
                                             Delete
                                             </button>
                                             </a>
                                    ...
                                    <?php
                                       ...
                                       if ($countRow > 0) {
                                          ...
                                          while ($row = mysqli_fetch_assoc($result)) {
                                             ...
                                             <td>{$row['description']}</td>
                                             <td>
                                             <a href='add_new_slider.php?edit3={$row['id']}'>
                                             <button data-toggle='tooltip' title='Edit' class='btn btn-primary mr-2'>
                                             Edit
                                             </button>
                                             </a>
                                             <a href='view_all_slider.php?delete3={$row['id']}'>
                                             <button data-toggle='tooltip' title='Trash' class='btn btn-primary mr-2'>
                                             Delete
                                             </button>
                                             </a>
