...
if(isset($_POST['save'])){
      ...
      $price=$_POST['price'];
      $query="INSERT INTO pasta_menu(image , title , description , price)
            VALUES('$image' , '$title' , '$description' , '$price')";
      $result= mysqli_query($conn,$query);}
      
if(isset($_GET['delete'])){ 
      $id=$_GET['delete'];
      $delQuery="DELETE FROM pasta_menu WHERE id=$id";
      $delResult= mysqli_query($conn,$delQuery);
}
if(isset($_GET['edit'])){
      $id=$_GET['edit'];
      $update=true;
      $editQuery="SELECT * FROM pasta_menu WHERE id=$id";
...
if(isset($_POST['editN'])){
      ...
      $editQuery="UPDATE pasta_menu SET image='$image' , title='$title, description='$description , price='$price' WHERE id='$id'";
      $editResult= mysqli_query($conn,$editQuery);
} 
?>
<!DOCTYPE html>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form class="forms-sample" action="add_pasta.php" method="POST">
                                ...
                                <div class="btns">
                                      <?php
                                            if($update==true): ?>
                                      <a href="view_pasta.php"><input class="btn btn-primary mr-2" type="submit"
                                                  name="editN" value="Edit"> </a>
                                      <?php else: ?>
                                      <a href="add_pasta.php"><input class="btn btn-primary mr-2" type="submit"
                                                  name="save" value="Save"> </a>
                                      <?php endif; ?>
                                      <button class="btn btn-light">Cancel</button>
                                      <a href="view_pasta.php" class="btn btn-primary mr-2">View all</a>
                                </div>
                            </form>
                        </div>
                    </div>
