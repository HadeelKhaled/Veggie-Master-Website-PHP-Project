...
if(isset($_POST['save'])){
      ...
      $query="INSERT INTO   says_our_customers(image , name , description )
            VALUES('$image' , '$name' , '$description' )";
      $result= mysqli_query($conn,$query);}
      
if(isset($_GET['delete'])){ 
      $id=$_GET['delete'];
      $delQuery="DELETE FROM  says_our_customers WHERE id=$id";
      $delResult= mysqli_query($conn,$delQuery);
}
if(isset($_GET['edit'])){
      $id=$_GET['edit'];
      $update=true;
      $editQuery="SELECT * FROM  says_our_customers WHERE id=$id";
...
if(isset($_POST['editN'])){
      ...
      $editQuery="UPDATE  says_our_customers SET image='$image' , name='$name, description='$description 'WHERE id='$id'";
      $editResult= mysqli_query($conn,$editQuery);
} 
?>
<!DOCTYPE html>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form class="forms-sample" action="add_new_cusSay.php" method="POST">
                                ...
                                <div class="btns">
                                      <?php
                                            if($update==true): ?>
                                      <a href="view_all_cusSay.php"><input class="btn btn-primary mr-2" type="submit"
                                                  name="editN" value="Edit"> </a>
                                      <?php else: ?>
                                      <a href="add_new_cusSay.php"><input class="btn btn-primary mr-2" type="submit"
                                                  name="save" value="Save"> </a>
                                      <?php endif; ?>
                                      <button class="btn btn-light">Cancel</button>
                                      <a href="view_all_cusSay.php" class="btn btn-primary mr-2">View all</a>
                                </div>
                            </form>
                        </div>
                    </div>
