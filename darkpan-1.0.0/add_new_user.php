...
if(isset($_POST['save'])){
      ...
      $query="INSERT INTO users(location,password,username,phone_number)
            VALUES('$location','$password','$username','$phone_number')";
...
if(isset($_POST['editUser'])){
      ...
      $username =$_POST['username'];
      $phone_number = $_POST['phone_number'];
      $editQuery="UPDATE users SET location='$location', password='$password', username='$username' , phone_number='$phone_number' WHERE id='$id'";
      $editResult= mysqli_query($conn,$editQuery);
} 
?>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form class="forms-sample" action="add_new_user.php" method="POST">
                                ...
                                name="phone_number" value="<?php echo $phone_number ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <?php
                                if($update==true): ?>
                                <a href="view_all_user.php"><input class="btn btn-primary mr-2" type="submit"
                                name="editUser" value="Edit"> </a>
                                <?php else: ?>
                                    <a href="add_new_user.php"><input class="btn btn-primary mr-2" type="submit"
                                    name="save" value="Save"> </a>
                                    <?php endif; ?>
                                    <button class="btn btn-light">Cancel</button>
                                    <a href="view_all_user.php" class="btn btn-primary mr-2">View users </a>
                                    </div>
                            </form>
                        </div>
                    </div>
