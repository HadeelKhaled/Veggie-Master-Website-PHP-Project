                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Footer information</h6>
                      ...
                      $sql = "SELECT * FROM contact_info";
                                ...
                                if ($countRow > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <td>{$row['address']}</td>
                                        <td>
                                        <a href='contact_add_info.php?edit={$row['id']}'>
                                        <button data-toggle='tooltip' title='Edit' class='btn btn-primary mr-2'>
                                        Edit
                                        </button>
                                        </a>
                                        <a href='contact_view_info.php?delete={$row['id']}'>
                      ...
                      $sql = "SELECT * FROM opening_hours";
                                ...
                                if ($countRow > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <a href='contact_view_info.php?deleteO={$row['id']}'>
                                          <button data-toggle='tooltip' title='Trash' class='btn btn-primary mr-2'>
                                          Delete
                                          </button>
                                          </a>
